...
import CompanyDetails from "../quotation/CompanyDetails"
import QuotationDetails from "../quotation/QuotationDetails"
import ClientDetails from "../quotation/ClientDetails"
...
const SurveyFormPage = () => {
  ...
  const handleSave = () => {
    ...
    // For this example, we'll just navigate to the invoice page with the form data
    navigate("/invoice", { state: { formData } })
  }

  return (
    <div className="container mx-auto px-4 py-8 bg-gray-50">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Create Quotation</h1>
      <CompanyDetails companyDetails={formData.companyDetails} handleChange={handleCompanyDetailsChange} />
      <QuotationDetails quotationDetails={formData.quotationDetails} handleChange={handleQuotationDetailsChange} />
      <ClientDetails clientDetails={formData.clientDetails} handleChange={handleClientDetailsChange} />
      <ItemsTable
